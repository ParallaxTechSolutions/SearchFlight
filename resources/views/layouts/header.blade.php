...
<link href="flight/images/favicon.png" rel="icon" />

<title>Quickai - Recharge & Bill Payment</title>
<meta name="description" content="Quickai - Recharge & Bill Payment">
...
<!-- Stylesheet
============================================= -->
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/bootstrap/css/bootstrap.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/font-awesome/css/all.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/owl.carousel/assets/owl.carousel.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/owl.carousel/assets/owl.theme.default.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/jquery-ui/jquery-ui.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/vendor/daterangepicker/daterangepicker.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('flight/css/stylesheet.css')}}" />
    ...
    <div class="container">
      <div class="header-row">
        <div class="header-column justify-content-start"> 
          ...
          <!-- Logo
          ============================================= -->
          <div class="logo"> <a href="index.html" class="d-flex" title="Quickai - HTML Template"><img src="{{asset('flight/images/logo.png')}}" alt="Quickai" /></a> </div>
          <!-- Logo end --> 
