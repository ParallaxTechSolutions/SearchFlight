...
class FillPermissionsForBravoBooking extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBravoBooking constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bravo-booking',
            'admin.bravo-booking.index',
            'admin.bravo-booking.create',
            'admin.bravo-booking.show',
            'admin.bravo-booking.edit',
            'admin.bravo-booking.delete',
            'admin.bravo-booking.bulk-delete',
        ]);
