...
class FillPermissionsForBravoBookingPayment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBravoBookingPayment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.bravo-booking-payment',
            'admin.bravo-booking-payment.index',
            'admin.bravo-booking-payment.create',
            'admin.bravo-booking-payment.show',
            'admin.bravo-booking-payment.edit',
            'admin.bravo-booking-payment.delete',
            'admin.bravo-booking-payment.bulk-delete',
        ]);
